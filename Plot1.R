...
ggplot(salaryPercent, aes(x = Year, y = FTEpercent)) +
  ...
  geom_text(aes(label=FTE), position=position_dodge(width=0.9), size=2,vjust=0, hjust=0) + 
...
ggplot(salaryPercent, aes(x = Year, y = FTCpercent)) +
  geom_bar(stat = "identity", fill = "green") + 
  geom_text(aes(label=FTC), position=position_dodge(width=0.9), size=2, vjust=0, hjust=0) + 
  theme(axis.text.x = element_text(angle = 0, hjust = 1)) +   
...
ggplot(salaryPercent, aes(x = Year, y = PTEpercent)) +
  geom_bar(stat = "identity", fill = "green") + 
  geom_text(aes(label=PTE), position=position_dodge(width=0.9), size=2, vjust=0, hjust=0) + 
  theme(axis.text.x = element_text(angle = 0, hjust = 1)) +   
...
ggplot(salaryPercent, aes(x = Year, y = PTCpercent)) +
  geom_bar(stat = "identity", fill = "green") + 
  geom_text(aes(label=PTC), position=position_dodge(width=0.9),size=2, vjust=0, hjust=0) + 
  theme(axis.text.x = element_text(angle = 0, hjust = 1)) +   
